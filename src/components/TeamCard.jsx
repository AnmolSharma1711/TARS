      ...
      <div className="team-container">
        <ScrollReveal>
          <div className="section-header">
            ...
            <p className="team-description text-gray-400 mt-2 font-orbitron telemetry-small" style={{color:'white', fontSize:16}}>Meet the brilliant minds leading STAR Command</p>
